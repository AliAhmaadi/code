                ...
                <div class="col-xs-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="recommended" id="recommended" class="form-control select2" style="width: 100%;">
                        <option value="none" {{ ($book->recommended == 'none') ? 'selected' : null }}>None</option>
                        <option value="recommended" {{ ($book->recommended == 'recommended') ? 'selected' : null }}>Recommended</option>
                      </select>
                    </div>
