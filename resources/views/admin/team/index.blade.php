        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                ...
                <div class="input-group input-group-sm" style="width: 250px;">
                    ...
                    request()->get('s') : null }}" class="form-control pull-right" placeholder="Search">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                        <img src="/uploads/{{$team->team_img }}"  width="80" height="80" class="img-thumbnail" alt="{{$team->team_img }}">
                        @endif
